...
class Config:
    ...
    def __init__(self):
        ...
        self.move_sound = Sound(
            os.path.join('H:/دانشگاه/python-chess-ai-yt-master/python-chess-ai-yt-master/assets/sounds/move.wav'))
        self.capture_sound = Sound(
            os.path.join('H:/دانشگاه/python-chess-ai-yt-master/python-chess-ai-yt-master/assets/sounds/capture.wav'))
